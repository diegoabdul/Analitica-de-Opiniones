...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.btn_prueba.sizePolicy().hasHeightForWidth())
        self.btn_atras.setSizePolicy(sizePolicy)
        self.btn_prueba.setSizePolicy(sizePolicy)
        ...
        self.gridLayout_4.addWidget(self.btn_prueba, 0, 1, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_algoritmo.setItemText(4, _translate("MainWindow", "SVM"))
        self.comboBox_algoritmo.setItemText(5, _translate("MainWindow", "KNN"))
